    ...
    div.innerHTML = `
        ...
        <div class="flex-1 flex flex-col gap-1">
            ...
            <div class="relative">
                <button type="button"
                    <button type="button"
				    class="dropdown-btn w-full text-xs p-1.5 border rounded bg-gray-50 text-gray-700 flex justify-between items-center whitespace-normal break-words">
                    <span class="dropdown-label whitespace-normal break-words">-- Lotura gabe --</span>
